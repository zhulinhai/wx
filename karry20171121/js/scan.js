...
// stage content:
(lib.k50 = function(mode,startPosition,loop) {
	setObject(this);
	...
	// btn_submit
	this.instance_3 = new lib.btn_submit();
	this.instance_3.parent = this;
	this.instance_3.setTransform(86.5,571.5);
...
// library properties:
lib.properties = {
	id: 'D4BB0AE68AF3C648B5B68FE03AB8E452',
	width: 1334,
	height: 646,
	fps: 32,
	color: "#FFFFFF",
...
an.compositions['D4BB0AE68AF3C648B5B68FE03AB8E452'] = {
