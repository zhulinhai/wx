...
(function ($){
    ...
    $.ajax({
        ...
        success:function(rt){
            ...
            var title ='为双十一疯狂打CALL'; // 分享标题
            var link ='http://wx.bjczxda.com/smallGame/index.html';
            var desc = '本游戏无奖品，无鼓励，因游戏太好玩而错失大好睡眠或良辰美景的同志所造成的损失一律不负责。'; // 分享描述
            var imgUrl = 'http://wx.bjczxda.com/smallGame/images/shareLogo.jpg';
